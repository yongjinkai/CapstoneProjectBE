...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/auth/api/**", "/public/api/**", "/api/user/**", "/api/patient/**", "/api/nurse/**").permitAll()
                        .requestMatchers("/api/admin/**").hasAnyAuthority("Admin")
                        .requestMatchers("/api/nurse/**").hasAnyAuthority("Nurse", "Admin")
                        .requestMatchers("/api/patient/**").hasAnyAuthority("Patient", "Admin")
                        .requestMatchers("/api/user/**").hasAnyAuthority("User", "Admin", "Nurse", "Patient")
                        .requestMatchers("/restricted/**").hasAnyAuthority("Patient", "Admin")
